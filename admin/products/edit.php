        ...
        <div class="col-12 col-md-9 col-lg-10 p-2 flex  text-center">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" required class="form-control" value="<?php echo $obj->image; ?>" name="image" id="image">
                </div>
                <div class="mb-3">
                ...
                <div>
                    ...
                    <input type="text" required class="form-control" value="<?php echo $obj->category_name; ?>" name="category_name" id="category_name">
                </div>
                <div>
